...
for fold in range(n_kfold):
    ...
    for train_index, test_index in kfold.split(np.arange(adj_mat_coo_data.shape[0])):
        ...
        model = GModel(adj_mat=sampler.train_data, gene=gene, cna=cna, mutation=mutation, sigma=2, k=3, iterates=2,
                       feature_drug=feature_drug, n_hid1=64, n_hid2=192, alpha=6.64, device="cuda:0")
