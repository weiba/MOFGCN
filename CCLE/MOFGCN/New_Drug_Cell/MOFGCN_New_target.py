...
def fmogc_new_target(gene, cna, mutation, drug_feature, response_mat, null_mask, target_dim, target_index,
                     evaluate_fun, sigma=2, knn=2, iterates=3, n_hid1=192, n_hid2=64, alpha=8.70, lr=1e-3,
    ...
    :return: epoch, treu data and predict data
    """
